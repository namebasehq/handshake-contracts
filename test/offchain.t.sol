...
contract SignatureVerification is Test {
    ...
    event LogUint(string message, uint data);
    ...
    function verifyOffchain(
        bytes memory ccip,
        bytes memory carry
    ) internal returns (bytes memory request, bytes memory response) {
        bytes memory sig;
        uint64 expires;
    ...
    function testVerifyOffchain() public {
        ...
        bytes memory ccip = hex"";
