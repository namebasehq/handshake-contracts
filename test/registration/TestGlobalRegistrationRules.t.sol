...
contract TestGlobalRegistrationRules is Test {
    ...
    function testClaimWithZeroDollars_fail() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(GlobalRegistrationRules.PriceTooLow.selector, 1 ether)
        );
    ...
    function testClaimWithLessThan365Days_fail() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(GlobalRegistrationRules.RegistrationTooShort.selector, 365)
        );
        bool result = rules.canRegister(
            buyingAddress,
            parentNamehash,
