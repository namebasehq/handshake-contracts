    ...
    event Approval(address indexed owner, address indexed approved, uint256 indexed tokenId);
        ...
        function setResolver(bytes32 node, address resolver) external override { revert("Not implemented"); }
        function ttl(bytes32 node) external view override returns (uint64) { revert("Not implemented"); }
        function resolver(bytes32 node) external view override returns (address) { revert("Not implemented"); }
        ...
        function setSubnodeRecord(bytes32 node, bytes32 label, address nodeOwner, address resolver, uint64 ttl) external override {
